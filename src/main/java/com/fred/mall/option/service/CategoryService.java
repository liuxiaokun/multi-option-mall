...
public interface CategoryService {
     ...
     * 保存一条 Category 数据。
     *
     * @param category 待保存的数据。
     * @throws BizException 保存失败异常。
     */
    void saveCategory(Category category) throws BizException;
     ...
     * @throws BizException 保存失败异常。
     */
    void saveCategoryList(List<Category> categoryList) throws BizException;

    /**
     * 根据id更新 Category，字段为null的选项会把数据库字段更新为null，即全部更新。
     *
     * @param category 更新的目标数据。
     */
     ...
     */
    void logicDeleteCategory(Long id, Long userId) throws BizException;
     ...
     */
    void deleteCategory(Long id) throws BizException;

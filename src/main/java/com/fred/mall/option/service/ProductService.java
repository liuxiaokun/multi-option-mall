...
public interface ProductService {
     ...
     * 保存一条 Product 数据。
     *
     * @param product 待保存的数据。
     * @throws BizException 保存失败异常。
     */
    void saveProduct(Product product) throws BizException;
     ...
     * @throws BizException 保存失败异常。
     */
    void saveProductList(List<Product> productList) throws BizException;

    /**
     * 根据id更新 Product，字段为null的选项会把数据库字段更新为null，即全部更新。
     *
     * @param product 更新的目标数据。
     */
     ...
     */
    void logicDeleteProduct(Long id, Long userId) throws BizException;
     ...
     */
    void deleteProduct(Long id) throws BizException;
